    ...
    <header class="profile-hero">
        ...
        <div class="profile-summary">
            <div id="profile-display">
                ...
                <div class="profile-level"><div class="profile-level-head"><strong>Seviye <?= $levelSummary['level'] ?></strong><span><?= $levelSummary['xp'] ?> XP</span></div><div class="profile-level-track"><i style="width:<?= $levelSummary['progress'] ?>%"></i></div><small>Sonraki seviyeye <?= max(0, $levelSummary['next'] - $levelSummary['xp']) ?> XP kaldı</small></div>
