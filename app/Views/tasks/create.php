...
<div class="task-form">
    ...
    <form method="post" action="<?= site_url('tasks') ?>">
        ...
        <textarea id="description" name="description" maxlength="5000" data-speech-input><?= esc(old('description')) ?></textarea>
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input id="due_date" type="date" name="due_date" value="<?= esc(old('due_date')) ?>">
            </div>
            <div>
                <label for="due_time">Son saat</label>
                <input id="due_time" type="time" name="due_time" value="<?= esc(old('due_time', '23:59')) ?>">
            </div>
        </div>
