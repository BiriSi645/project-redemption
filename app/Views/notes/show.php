...
<article class="note-detail">
    ...
    <div class="note-detail-content" style="margin:24px 0; line-height:1.7; white-space:pre-wrap"><?= esc($note['content']) ?></div>
            ...
            <?php foreach ($comments as $comment): ?>
                ...
                <article class="comment-card">
                    <div class="comment-meta">
                        <div><strong><?= esc($comment['username'] ?? 'Silinmiş kullanıcı') ?></strong><?php if ((int) $comment['user_id'] === (int) $note['user_id']): ?><span class="note-owner-badge">Not sahibi</span><?php endif; ?></div>
