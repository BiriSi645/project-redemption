...
<div class="journal-form">
    ...
    <form method="post" action="<?= site_url('journal') ?>" data-journal-draft data-draft-key="project-redemption:journal-draft:<?= (int) session()->get('user_id') ?>:new">
        <?= csrf_field() ?>
        <div class="form-grid">
            <div>
        ...
        <textarea id="content" name="content" maxlength="20000" placeholder="Bugün neler oldu? Neler hissettiniz?" data-speech-input required><?= esc(old('content')) ?></textarea>
