...
<div class="journal-form">
    ...
    "user_id",
        ...
        <div class="form-grid">
            <div>
                ...
                <input id="entry_date" type="date" name="entry_date" value="<?= esc(
                    old("entry_date", $entry["entry_date"]),
                ) ?>" required>
            </div>
            <div>
                <label for="mood">O gün nasıl hissediyordunuz?</label>
                <select id="mood" name="mood" required>
                    <option value="great" <?= $selectedMood === "great"
                        ? "selected"
                        : "" ?>>😄 Harika</option>
                    <option value="good" <?= $selectedMood === "good"
                        ? "selected"
                        : "" ?>>🙂 İyi</option>
                    <option value="neutral" <?= $selectedMood === "neutral"
                        ? "selected"
                        : "" ?>>😐 Normal</option>
                    <option value="bad" <?= $selectedMood === "bad"
                        ? "selected"
                        : "" ?>>😕 Kötü</option>
                    <option value="awful" <?= $selectedMood === "awful"
                        ? "selected"
                        : "" ?>>😞 Çok kötü</option>
                </select>
            </div>
        ...
        <textarea id="content" name="content" maxlength="20000" data-speech-input required><?= esc(
