...
class Games extends BaseController
{
    ...
    {
        return view('games/index', ['title' => 'Oyunlar']);
    }
    ...
    public function snake(): string
    {
        ...
        return view('games/snake', [
            'title' => 'Yılan Oyunu',
            'userId' => $userId,
            'personalBest' => $scoreModel->personalBest($userId, 'snake', 'default') ?? 0,
            'leaderboard' => $scoreModel->leaderboard('snake', 'default'),
        ]);
    }
    ...
    public function sudoku(): string
    {
        ...
        $personalBests = [];
        foreach (['beginner', 'medium', 'expert'] as $difficulty) {
            $leaderboards[$difficulty] = $scoreModel->leaderboard('sudoku', $difficulty);
            $personalBests[$difficulty] = $scoreModel->personalBest($userId, 'sudoku', $difficulty);
        }
    ...
    public function saveScore()
    {
        ...
        $result = (new GameScoreModel())->recordBest((int) session()->get('user_id'), $game, $difficulty, (int) $score);
